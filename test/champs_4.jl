function champs_4(t, fft_ubar, fft_vbar, fft_ug, fft_vg, A1, A2, matr,
    ...
    h1u, h1v = ftau(t, fft_ubar, fft_vbar, A1, A2, matr, conjmatr, sigma, llambda)
    ...
    champu1, champv1 = duftau(t, fft_ubar, fft_vbar, dtu0u, dtu0v,
    ...
    champu, champv = ftau(t, fft_ubar + h1u, fft_vbar + h1v, A1, A2, matr,
    ...
    champu2, champv2 = dtduftau(t, fft_ubar, fft_vbar, dtu0u, dtu0v, 
                                A1, A2, matr, conjmatr, sigma, llambda, Ntaumm)

    champu3, champv3 = duftau(t, fft_ubar, fft_vbar, dttu0u, dttu0v, 
                              A1, A2, matr, conjmatr, sigma, llambda, Ntaumm)

    champu4, champv4 = d2tftau(t, fft_ubar, fft_vbar, A1, A2, 
                               matr, conjmatr, sigma, llambda, Ntaumm)
    ...
    champu1, champv1 = duftau(t, fft_ubar + h1u, fft_vbar + h1v,
                              dtu1u + dth1u, dtu1v + dth1v, A1, A2, matr,
                              conjmatr, sigma, llambda, Ntaumm)

    champu2, champv2 = dtftau(t, fft_ubar + h1u, fft_vbar + h1v, A1, A2,
                              matr, conjmatr, sigma, llambda, Ntaumm)
    ...
    h3u, h3v = ftau(t, fft_ubar + h2u, fft_vbar + h2v, A1, A2, matr,
                    conjmatr, sigma, llambda)
    ...
    C3u = sp.tile(fft_ubar, (Ntaumm, 1)) + h3u
    C3v = sp.tile(fft_vbar, (Ntaumm, 1)) + h3v

    ffu, ffv = ftau(t, C3u + fft_ug, C3v + fft_vg, A1, A2, matr, conjmatr,
                    sigma, llambda)

    champu, champv = ftau(t, C3u, C3v, A1, A2, matr, conjmatr, sigma, llambda)
    ...
    champu1, champv1 = duftau(t, fft_ubar + h1u, fft_vbar + h1v,
                              champubaru + dth1baru, champubarv + dth1barv,
                              A1, A2, matr, conjmatr, sigma, llambda, Ntaumm)
    ...
    champu1, champv1 = d2uftau(t, fft_ubar, fft_vbar, dtu0u, dtu0v, 
                               champubaru, champubarv, A1, A2, matr, conjmatr,
    ...
    champu3, champv3 = dtduftau(t, fft_ubar, fft_vbar, dtu0u, dtu0v, 
                                A1, A2, matr, conjmatr, sigma, llambda, Ntaumm)
    champu4, champv4 = dtduftau(t, fft_ubar, fft_vbar, champubaru, champubarv,
                                A1, A2, matr, conjmatr, sigma, llambda,
                                Ntaumm)
    champu5, champv5 = d2tftau(t, fft_ubar, fft_vbar, A1, A2, matr, conjmatr, 
                               sigma, llambda, Ntaumm)
    ...
    champu1, champv1 = d3uftau(t, fft_ubar, fft_vbar, dtu0u, dtu0v, 
                               dtu0u, dtu0v, champubaru, champubarv, A1, A2, matr,
                               conjmatr, sigma, llambda, Ntaumm)

    champu2, champv2 = dtd2uftau(t, fft_ubar, fft_vbar, dtu0u, dtu0v, 
                                 dtu0u, dtu0v, A1, A2, matr, conjmatr, sigma,
                                 llambda, Ntaumm)

    champu3, champv3 = d2uftau(t, fft_ubar, fft_vbar, 
                               dttu0baru, dttu0barv, dtu0u, dtu0v, A1, A2,
                               matr, conjmatr, sigma,
                               llambda, Ntaumm)

    champu4, champv4 = dtd2uftau(t, fft_ubar, fft_vbar, dtu0u, dtu0v,
                                 champubaru, champubarv, A1, A2, matr, conjmatr,
                                 sigma, llambda, Ntaumm)

    champu5, champv5 = d2tduftau(t, fft_ubar, fft_vbar, dtu0u, dtu0v,
                                 A1, A2, matr, conjmatr, sigma, llambda, Ntaumm)
    ...
    champu7, champv7 = d2uftau(t, fft_ubar, fft_vbar,
                               dttu0u, dttu0v, champubaru, champubarv, 
                               A1, A2, matr, conjmatr,
                               sigma, llambda, Ntaumm)

    champu8, champv8 = dtduftau(t, fft_ubar, fft_vbar,
                                dttu0u, dttu0v, A1, A2, matr, 
                                conjmatr, sigma, llambda, Ntaumm)

    champu9, champv9 = duftau(t, fft_ubar, fft_vbar, 
dtttu0baru, dtttu0barv, A1, A2, matr, conjmatr, sigma, llambda,
                              Ntaumm)

    champu10, champv10 = d3tftau(t, fft_ubar, fft_vbar, A1, A2,
 matr, conjmatr, sigma, llambda, Ntaumm)

    champu11, champv11 = d2tduftau(t, fft_ubar, fft_vbar, 
champubaru, champubarv, A1, A2, matr, conjmatr, sigma,
                                   llambda, Ntaumm)
    ...
    champv = champv1 + champv2 + 2 * champv3 + 2 * champv4 
             + 2 * champv5 + 2 * champv6 + champv7 + champv8 + champv9  
             + champv10 + champv11
    ...
    champu1, champv1 = d2uftau(t, fft_ubar + h1u, fft_vbar + h1v,
                               dtu1u + dth1u, dtu1v + dth1v,
                               champubaru + dth1baru, champubarv + dth1barv,
                               A1, A2, matr, conjmatr, sigma, llambda, Ntaumm)

    champu2, champv2 = duftau(t, fft_ubar + h1u, fft_vbar + h1v,
                              dttu1baru + dtth1baru, dttu1barv + dtth1barv,
                              A1, A2, matr, conjmatr, sigma, llambda, Ntaumm)

    champu3, champv3 = dtduftau(t, fft_ubar + h1u, fft_vbar + h1v,
                                dtu1u + dth1u, dtu1v + dth1v, A1, A2, matr,
                                conjmatr, sigma, llambda, Ntaumm)

    champu4, champv4 = dtduftau(t, fft_ubar + h1u, fft_vbar + h1v,
                                champubaru + dth1baru,
                                champubarv + dth1barv, A1, A2, matr, 
                                conjmatr, sigma, llambda,
                                Ntaumm)

    champu5, champv5 = d2tftau(t, fft_ubar + h1u, fft_vbar + h1v, A1, A2,
                               matr, conjmatr, sigma, llambda, Ntaumm)
    ...
    champu1, champv1 = duftau(t, fft_ubar + h2u, fft_vbar + h2v,
                              champubaru + dth2baru, champubarv + dth2barv,
                              A1, A2, matr, conjmatr, sigma, llambda, Ntaumm)

    champu2, champv2 = dtftau(t, fft_ubar + h2u, fft_vbar + h2v, A1, A2,
                              matr, conjmatr, sigma, llambda, Ntaumm)
