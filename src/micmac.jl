...
struct MicroMacro
    ...
    function MicroMacro( dataset,ntau )
...
function run(m :: MicMac, dt, ntau)
    ...
    champu = similar(fft_u)
    champv = similar(fft_v)

    champu_fft = similar(fft_u)
    champv_fft = similar(fft_v)
    ...
    C1u, C1v = C1(0.0, fft_ubar, fft_vbar, A1, A2, matr,
	...
	fft_vg12 .+= dt/2 * champmoyv
        ...
        champu1, champv1 = duftau(m, t+dt/2, fft_ubar12, fft_vbar12, champubaru, champubarv)
